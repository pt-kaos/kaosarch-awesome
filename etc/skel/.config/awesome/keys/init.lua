...
require("utils")  -- Auxiliary Functions
...
globalkeys = my_table.join(
    ...
    -- dmenu
    awful.key({ modkey, "Shift"   }, "d", dmenu_run_f,
    ...
    awful.key({ modkey }, "F4", function () awful.util.spawn( mailclient ) end,
        {description = mailclient , group = "function keys" }),
    awful.key({ modkey }, "F5", function () awful.util.spawn( pwmanager ) end,
        {description = pwmanager , group = "function keys" }),
    awful.key({ modkey }, "F6", function () awful.util.spawn( mediaplayer ) end,
    ...
    awful.key({ modkey }, "F9", function () awful.util.spawn( "rofi -theme-str 'window {width: 100%;height: 100%;}' -show drun" ) end,
        {description = "rofi fullscreen" , group = "function keys" }),
    awful.key({ modkey }, "F10", function () awful.util.spawn( "rofi -show drun" ) end,
        {description = "rofi" , group = "function keys" }),
    awful.key({ modkey }, "F11", dmenu_run_f,
        {description = "Dmenu Prompt" , group = "function keys" }),
    awful.key({ modkey }, "F12", function () awful.util.spawn( "set_xset.py" ) end,
        {description = "Act/Deact screen timeout" , group = "function keys" }),

    -- super + ...
    --awful.key({ modkey }, "Return", function() awful.util.spawn( terminal ) end,
    --    {description = "Terminal", group = "Tools"}),
    awful.key({ modkey }, "b", function () awful.util.spawn( terminal .." -e bashtop" ) end,
        {description = "Bash Top", group = "Tools"}),
    awful.key({ modkey }, "e", function () awful.util.spawn( "dm_configfiles" ) end,
        {description = "Edit Config Files", group = "Tools"}),
    --awful.key({ modkey }, "h",  EM USO
    --awful.key({ modkey }, "j",  EM USO
    --awful.key({ modkey }, "k",  EM USO
    --awful.key({ modkey }, "l",  EM USO
    --awful.key({ modkey }, "o",  EM USO
    --awful.key({ modkey }, "q",  EM USO
    ...
    --awful.key({ modkey }, "s",  EM USO
    awful.key({ modkey }, "t", function () awful.util.spawn( terminal ) end,
        {description = "terminal", group = "super"}),
    --awful.key({ modkey }, "u",  EM USO
    awful.key({ modkey }, "v", function () awful.util.spawn( "pavucontrol" ) end,
        {description = "Pulseaudio Control", group = "super"}),
    --awful.key({ modkey }, "x",  function () awful.util.spawn( "archlinux-logout" ) end,
    --    {description = "exit/logout", group = "hotkeys"}),
    --awful.key({ modkey }, "w",  EM USO => Show/Hide Wibox
    --awful.key({ modkey }, "y",  LIVRE
    awful.key({ modkey }, "z", function() awful.screen.focused().quake:toggle() end,
        {description = "Quake Terminal", group = "Tools"}),
    awful.key({ modkey }, "Escape", function() awful.util.spawn(terminal .. " -e bashtop") end,
        {description = "BashTop Task Manager", group = "Tools"}),
    ...
    awful.key({ modkey, "Shift" }, "Escape", function() awful.util.spawn("xfce4-taskmanager") end,
        {description = "XFCE Task Manager", group = "Tools"}),
    ...
    awful.key({ modkey1, altkey }, "b", function() awful.util.spawn( browser2 ) end,
        {description = browser2, group = "alt+ctrl"}),
    awful.key({ modkey1, altkey }, "f", function() awful.util.spawn( browser1 ) end,
        {description = browser1, group = "alt+ctrl"}),
    awful.key({ modkey1, altkey }, "g", function() awful.util.spawn( filemanager ) end,
        {description = filemanager, group = "alt+ctrl"}),
    --awful.key({ modkey1, altkey }, "h", EM USO
    awful.key({ modkey1, altkey }, "i", function() awful.util.spawn("nitrogen") end,
        {description = "nitrogen", group = "alt+ctrl"}),
    --awful.key({ modkey1, altkey }, "j", EM USO
    ...
    awful.key({ modkey1, altkey }, "s", function() awful.util.spawn(terminal .. " -e xdg-open $(fzf)") end,
        {description = "FZF Search file & open", group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey }, "v", function() awful.util.spawn( "pavucontrol" ) end,
    ...
    awful.key({ modkey1, altkey }, "x",  function () awful.util.spawn( "archlinux-logout" ) end,
        {description = "exit/logout", group = "hotkeys"}),
    awful.key({ modkey1, altkey }, "Escape", function() awful.util.spawn(terminal .. " -e htop") end,
        {description = "HTOP Task Manager", group = "Tools"}),
    ...
    --    {description = "Pywal Wallpaper trash", group = "Alt+Shift"}),
    ...
    --    {description = "Pywal Wallpaper previous", group = "Alt+Shift"}),
    awful.key({ altkey, "Shift" }, "Escape", function () awful.util.spawn( "xkill" ) end,
    ...
    awful.key({ altkey }, "F3", function () awful.util.spawn( "xfce4-appfinder" ) end,
        {description = "Xfce appfinder", group = "altkey"}),
    awful.key({ altkey }, "F4", function() awful.util.spawn(terminal .. " -e xdg-open $(fzf)") end,
        {description = "FZF Search file & open", group = "altkey"}),
    ...
    -- Tag browsing modkey + tab => These two I want to change the client view/focus
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey }, "l",
        ...
        awful.key({ modkey1, modkey }, "Up",
            ...
            {description = "focus up", group = "client"}),
        -- modkey + Control passam a mudar de ecra
    ...
    awful.key({ modkey1, modkey }, "Right", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen", group = "screen"}),
    awful.key({ modkey1, modkey }, "Left",  function () awful.screen.focus_relative(-1) end,
              {description = "focus the previous screen", group = "screen"}),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ }, "XF86AudioMute",
        ...
        {description="Volume Toggle Mute"}),
...
--Media keys supported by mpd.
    ...
    --awful.key({ modkey1 }, "c", function () awful.spawn.with_shell("xsel | xsel -i -b") end,
    --    {description = "copy terminal to gtk", group = "hotkeys"}),
    --Copy clipboard to primary (gtk to terminals)
    --awful.key({ modkey1 }, "v", function () awful.spawn.with_shell("xsel -b | xsel") end,
